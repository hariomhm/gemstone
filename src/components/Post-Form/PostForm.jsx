...
export default function PostForm({ post }) {
    ...
    const submit = async (data) => {
        if (post) {
            ...
            if (file) {
                authService.deleteFile(post.imageFile);
            }

            const dbPost = await authService.updatePost(post.$id, {
                ...data,
                imageFile: file ? file.$id : undefined,
            });
            ...
            if (file) {
                ...
                const dbPost = await authService.createPost({ ...data, userId: userData.$id });
            ...
            <div className="w-1/3 px-2">
                ...
                {post && (
                    <div className="w-full mb-4">
                        <img
                            src={authService.getFilePreview(post.imageFile)}
                            alt={post.title}
